var app = (function (exports) {
  ...
  function init$1(userParams) {
    const { source, defaultID } = setParams$3(userParams);
  ...
  function init(userParams) {
    const { layers } = setParams$2(userParams);
...
`;
  ...
  function initPrograms(context, framebuffer, preamble, multiTile) {
    ...
    function setupSymbol() {
      ...
      const textProg = setupProgram(initText$1(context));
  ...
  function initGLpaint(userParams) {
    const { context, framebuffer, preamble, multiTile } = setParams$1(userParams);
  ...
  function main() {
    loadStyle(styleHref, mapboxToken).then(getTile);
  }
